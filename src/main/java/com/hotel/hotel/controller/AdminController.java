...
public class AdminController {
    ...
    public AdminController(ReservaRepository reservaRepository, FacturaRepository facturaRepository,
            HotelRepository hotelRepository, HabitacioRepository habitacioRepository,
            EmpleatsRepository empleatsRepository, TascaRepository tascaRepository, ClientsRepository clientsRepository,
